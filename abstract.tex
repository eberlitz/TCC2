...
As a second contribution, we adapted the studies regarding the addition of syntactic context in the training process of word embeddings to a Brazilian Portuguese corpus, in which we found similar results through qualitative evaluation.
