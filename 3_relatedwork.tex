...
Regarding the work from \citetexto{gonccalo2018distributional}, they didn't evaluate different dimension sizes for the word embedding models, also they didn't compare results with the DEPS word embeddings that include syntactic knowledge, so in our work we intend to do this evaluation and also compare results with our own generated word embeddings, instead of examining only the NILC available ones.
